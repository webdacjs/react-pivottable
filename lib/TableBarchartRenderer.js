...
var TableBarchartRenderer = function (_React$PureComponent) {
  ...
  _createClass(TableBarchartRenderer, [{
    ...
    value: function render() {
      ...
      var maxValsAttrs = (0, _TableBarchartUtils.getMaxValsAttrs)(pivotData.rowTotals, pivotData.props.vals, stacked);
      var minValsAttrs = (0, _TableBarchartUtils.getMinValsAttrs)(pivotData.rowTotals, pivotData.props.vals, stacked);
      ...
      function getBarChart(index, width, value, thiskey, stacked) {
        ...
        return stacked ? _react2.default.createElement(
          'div',
      ...
      function getCellValue(i, j, rowKey, colKey) {
        ...
        return _react2.default.createElement(
          ...
          stacked && _react2.default.createElement(
            'div',
            { className: 'bar-chart-bar', key: 'bar-chart-' + i },
            values.map(function (value, i) {
              return getBarChart(i, getPercentageFromValue(value, keys[i]), getBarValue(value, getPercentageFromValue(value, keys[i])), keys[i], stacked);
            })
          ),
      ...
      function getTableHeader() {
        return _react2.default.createElement(
          ...
          rowAttrs.length !== 0 && [_react2.default.createElement(
            ...
            _react2.default.createElement('th', { colSpan: rowAttrs.length }),
            legendValues.map(function (val) {
              return _react2.default.createElement(
                'th',
                null,
                _react2.default.createElement(
