      ...
      return function () {
        return {
          ...
          push: function push(record) {
            ...
            attr.forEach(function (thisAttr, i) {
              if (!isNaN(parseFloat(record[attr[i]]))) {
                _this.sum[thisAttr] = (_this.sum[thisAttr] | 0) + parseFloat(record[attr[i]]);
              }
            });
          },
          value: function value() {
...
var PivotData = function () {
  function PivotData() {
    ...
    this.isMultipe = (this.props.aggregatorName || '').toLowerCase().includes('multi');
    this.tree = {};
      ...
      var sortersArr = function () {
        ...
        try {
          for (var _iterator = Array.from(attrs)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            result.push(getSort(_this4.props.sorters, a));
          }
        } catch (err) {
