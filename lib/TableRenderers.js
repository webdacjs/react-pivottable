...
var spanSize = function spanSize(arr, i, j, multi, valsAttrs) {
  var x = void 0;
  if (i !== 0) {
    var asc = void 0,
        end = void 0;
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            colAttrs.map(function (c, j) {
              return _react2.default.createElement(
                ...
                colKeys.map(function (colKey, i) {
                  var x = spanSize(colKeys, i, j, multiValue, valsAttrs);
                  if (x === -1) {
                    return null;
                  }
                  return _react2.default.createElement(
                    ...
                    colKey[j],
                    multiValue && valsAttrs && valsAttrs.map(function (x) {
                      return _react2.default.createElement(
                        'th',
                        null,
                        x
            ...
            rowAttrs.length !== 0 && _react2.default.createElement(
              ...
              colAttrs.length === 0 && multiValue && valsAttrs && valsAttrs.map(function (x) {
                return _react2.default.createElement(
                  'th',
                  null,
                  x
            ...
            rowKeys.map(function (rowKey, i) {
              ...
              return _react2.default.createElement(
                ...
                !hideRowTotals && _react2.default.createElement(
                  ...
                  getFormattedValue(totalRowValue, totalAggregator, formatter)
                )
              );
            }),
              ...
              colKeys.map(function (colKey, i) {
                ...
                if (!multiValue) {
                  return _react2.default.createElement(
                    ...
                    getFormattedValue(totalAggregator.value(), totalAggregator, formatter)
                  );
                }
                var totalValuesWithKeys = totalAggregator.value();
                var totalvalues = Object.keys(totalValuesWithKeys).map(function (k) {
...
var RawExportRenderer = function (_React$PureComponent3) {
  _inherits(RawExportRenderer, _React$PureComponent3);

  function RawExportRenderer() {
    _classCallCheck(this, RawExportRenderer);

    return _possibleConstructorReturn(this, (RawExportRenderer.__proto__ || Object.getPrototypeOf(RawExportRenderer)).apply(this, arguments));
  }

  _createClass(RawExportRenderer, [{
    key: 'render',
    value: function render() {
      var pivotData = new _Utilities.PivotData(this.props);
  ...
  return RawExportRenderer;
}(_react2.default.PureComponent);

RawExportRenderer.defaultProps = _Utilities.PivotData.defaultProps;
RawExportRenderer.propTypes = _Utilities.PivotData.propTypes;
