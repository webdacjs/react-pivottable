...
function BarChartComponent(_ref) {
  ...
  var popOverValues = [].concat(_toConsumableArray(rowkey), _toConsumableArray(values));
  ...
  return showPopOver ? _react2.default.createElement(
    _reactPopover2.default,
    { isOpen: hovered, preferPlace: 'below', body: getPopOver() },
